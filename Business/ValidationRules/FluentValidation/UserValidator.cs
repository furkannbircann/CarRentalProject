...
namespace Business.ValidationRules.FluentValidation
{
    public class UserValidator : AbstractValidator<User>
    {
        public UserValidator()
        {
            ...
            RuleFor(u => u.Password).NotEmpty().WithMessage("Password alanı boş olamaz");
            ...
            RuleFor(u => u.Password).MinimumLength(3).WithMessage("Password alanı en az 3 karakter olmalıdır");
